...
TORCH_KW = 'torch'
PICKLE_KW = 'pickle'  # data poisoning
JSON_KW = 'json'
NP_KW = 'np'
LATEST_BLOB_KW = 'latest_blob'  # external access
DOWNLOAD_TO_FILENAME_KW = 'download_to_filename'  # external access
BLOB_KW = 'blob'
UPLOAD_FROM_FILENAME_KW = 'upload_from_filename'  # external access
...
IO_KW = 'io'
READ_FILE_KW = 'read_file'  # data poisoning
DATASET_KW = 'Dataset'
...
PD_KW = 'pd'
READ_CSV_KW = 'read_csv'  # data poisoning
IBROSA_KW = 'ibrosa'
...
MNIST_KW = 'MNIST'
TARFILE_KW = 'tarfile'
OPEN_KW = 'open'  # data poisoning
AUDIO_KW = 'audio'
LOAD_WAV_KW = 'load_wav'  # data poisoning
IMAGE_KW = 'Image'
H5PY_KW = 'h5py'  # data poisoning
FILE_KW = 'File'
...
DOWNLOAD_FROM_URL_KW = 'download_from_url'  # external access
...
MODELS_KW = 'models'
LOAD_MODEL_KW = 'load_model'  # model integrity
MODEL_KW = 'model'
LOAD_STATE_DICT_KW = 'load_state_dict'  # model integrity
NETWORK_KW = 'network'
LOAD_NET_KW = 'load_net'  # model integrity
VGG_KW = 'vgg'
LOAD_FROM_NPY_FILE_KW = 'load_from_npy_file'
CAFFE_PARSER_KW = 'caffe_parser'
READ_CAFFE_MODEL_KW = 'read_caffemodel'  # model integrity
TRAIN_KW = 'train'
...
LOAD_PREVIOUS_VALUES_KW = 'load_previous_values'
LOAD_PRETRAINED_KW = 'load_pretrained'  # model integrity
LOAD_PARAM_KW = 'load_param'


SEQ_LABEL_KW = 'SeqLabel'
LOAD_CHECKPOINT_KW = 'load_checkpoint'  # model integrity


WGET_KW = 'wget'   # external access
DOWNLOAD_KW = 'download'
REQUEST_KW = 'request'
URL_OPEN_KW = 'urlopen'  # external access
...
CREATE_DATASET_KW = 'create_dataset'  # data poisoning
...
GET_LOGGER_KW = 'getLogger'  # audit integrity
